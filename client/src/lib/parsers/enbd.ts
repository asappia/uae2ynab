...
export async function parseENBDAccount(file: File): Promise<ParseResult> {
  ...
  try {
    ...
    //   24 Jan 2026        CC NO.-4000********0000 RMA REF NO.-                 -38564.24                                     3341.06 Cr
    //                      EBIDSAMPLE00001 4
    //   24 Jan 2026        IPP 20260101ADCSAMPLE00000000001                                            2939.21                 41905.30 Cr
    //                      100000001 AED 2939 .21 SAMPLE
    //                      NAME OWN ACCOUNT TRANSFERTO ENBD
    //
